...
Widget _buildSearchBar() {
    ...
    builder: (context, mapProvider, _) {
        ...
        onSubmitted: (query) async {
            ...
            await mapProvider.searchLocations(query);
            setState(() {
                _isSearching = false;
            });
            }
...
Widget _buildMap(MapProvider mapProvider) {
    ...
    final LatLng center = mapProvider.currentLocation != null
        ? LatLng(
...
List<Marker> _buildMarkers(MapProvider mapProvider) {
    ...
    markers.add(
        ...
        onTap: () {
            ...
            mapProvider.getLocationDetails(location); // Get detailed information when selected
            _mapController.move(
